...
export class MenuItem {
  constructor(DOM_el) {
    ...
    const boundariesItem = {
      x: gsap.utils.random(-10, 10),
      y: gsap.utils.random(-15, 15),
      r: gsap.utils.random(-2, 2),
    };
    this.mouseMoveItemController = new MouseMoveController(
      this.DOM.el,
      boundariesItem
    );

    const boundariesStack = { x: 50, y: 100 };
    this.mouseMoveStackController = new MouseMoveController(
      this.DOM.imgStack,
      boundariesStack
    );
    ...
    this.DOM.contentTitleChars =
      this.DOM.contentTitle.querySelectorAll(".char");
  }
