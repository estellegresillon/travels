...
export class Menu {
  ...
  selectItem(pos) {
    ...
    this.openItemTimeline
      ...
      .set(
        [
          menuItemCurrent.DOM.contentTitleChars,
          menuItemCurrent.DOM.contentText,
        ],
        {
          opacity: 0,
        },
    ...
    this.openItemTimeline
      .to(
        menuItemCurrent.DOM.stackImages,
        {
          duration: 1.6,
          ease: "expo.inOut",
          x: (_, t) => {
            ...
            const tx =
              ...
              (winsize.width / 2 -
                t.offsetWidth / 2 -
                (imgCounter * t.offsetWidth + 40 * imgCounter));
            t.dataset.tx = tx;
            return tx;
          },
          y: (_, t) => {
    ...
    this.menuItems.forEach((item) => {
      ...
      this.openItemTimeline.to(
        item.DOM.chars,
        {
          ...
          onComplete: () =>
            this.menuItems[this.current].DOM.el.classList.remove(
              "menu__item--current"
            ),
        },
        0
